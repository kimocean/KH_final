...
<h1>상품 등록</h1>
<form action="/product/productinsert" method="post"> <br/>
product_no : <input type="text" name="product_no"> <br/>
상품명 : <input type="text" name="product_name"> <br/>
카테고리(지역) :  <input type="text" name="category_local_no">
<select name="category_name">
<option value=""></option>
</select> <br/>
카테고리(종류) :  <input type="text" name="category_type_no"> <br/>
...
<input type="text" name="option_no"><br/>
